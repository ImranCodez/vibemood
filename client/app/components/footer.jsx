...
export default function Footer() {
  ...
  return (
    <footer className="bg-black text-gray-300">
      ...
      {/* Bottom */}
      <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-4 px-4 py-6 text-center text-sm text-gray-500 sm:px-6 md:flex-row md:text-left">
